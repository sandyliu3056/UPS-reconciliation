...
ok(all.length===11, '\u5171 '+all.length+' \u96bb\uff0811 \u500b\u4f4d\u7f6e\uff09');
const want={'p-setting':'cat','p-code':'cat','p-chan':'cat','p-files':'cat',
...
const keys=['p-setting','p-code','p-cus','p-chan','p-rules','p-ratefill','p-files','recon','p-analysis','p-hist','p-admin'];
let xmlOk=0;
keys.forEach(k=>{
...
ok(D.querySelectorAll('.mzwrap').length===11, '\u9084\u662f 11 \u96bb');
