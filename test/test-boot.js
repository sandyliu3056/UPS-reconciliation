...
setTimeout(()=>{
  ...
  ['1. Rate Levels','2. UPS Code Lookup','1. General Settings','1. Customer Directory','2. Surcharge Catalog',
   '1. Base Rates','2. Fuel Surcharge','3. Surcharge Rates','4. Dimensional Rules','5. Demand Surcharge']
    .forEach(n=>ok(sub.indexOf(n)>=0, '\u5b50\u9801\uff1a'+n));
  ok(D.querySelectorAll('.mzwrap').length===11, '11 \u96bb\u90fd\u5728\u9801\u4e0a');
