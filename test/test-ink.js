...
ok(D.querySelectorAll('.sketch').length===59&&D.querySelectorAll('.sketch-soft').length===16,
   '59 個 .sketch、16 個 .sketch-soft 都在');
ok(D.querySelectorAll('table').length===31&&D.querySelectorAll('.modalbg').length===26,
   '\u8868\u683c 31\u3001\u8996\u7a97 26');
ok(D.querySelectorAll('[data-i18n]').length===581, 'i18n 標記 581 個(自訂代碼卡退役)');
